/**
 * @fileoverview OOM-safe Vitest runner for sizeofvar — delegates to
...
// (after it). Without a `--`, the legacy heuristic applies: non-flag tokens are
// test patterns and flag tokens are forwarded to vitest.
